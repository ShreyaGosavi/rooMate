...
export class UploadService {
  ...
  async uploadPhoto(file: Express.Multer.File, propertyId: string): Promise<string> {
  ...
  async uploadOwnershipProof(file: Express.Multer.File, propertyId: string): Promise<string> {
