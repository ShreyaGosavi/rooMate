export function communityApprovedTemplate(communityName: string): string {
  return `
<!DOCTYPE html>
<html>
<body style="font-family: Arial, sans-serif; background: #f8fafa; padding: 40px 0;">
  <div style="max-width: 560px; margin: 0 auto; background: white; border-radius: 16px; padding: 40px;">
    ...
    <a href="http://localhost:3000/communities" style="display:inline-block;margin-top:24px;background:#061b32;color:white;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;">View Community</a>
