                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-[#e2e8f0] pt-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Link href={`/listings/edit/${p.id}`} className="flex h-8 w-8 items-center justify-center rounded-lg border border-[#e2e8f0] text-[#061b32]/40 hover:border-[#9fdbda] hover:text-[#061b32] transition-all">
