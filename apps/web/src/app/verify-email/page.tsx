      ...
      <div className="w-full max-w-md text-center px-6">
        {status === 'loading' && (
          <>
            ...
            <p className="mt-6 text-[#061b32] font-medium">Verifying your email...</p>
          </>
        )}
        {status === 'success' && (
          <>
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#9fdbda]/20">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#9fdbda" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12"/>
              </svg>
            </div>
            <h1 className="mt-6 text-2xl font-bold text-[#061b32]">Email verified!</h1>
        ...
        {status === 'error' && (
          <>
            ...
            <h1 className="mt-6 text-2xl font-bold text-[#061b32]">Verification failed</h1>
            <p className="mt-2 text-sm text-[#061b32]/60">
